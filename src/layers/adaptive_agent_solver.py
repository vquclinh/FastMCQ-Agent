...
from src.selector.confidence import assess_confidence
from src.utils.labels import index_to_label, is_valid_label
...
class AdaptiveAgentSolver(BaseSolver):
    ...
    def __init__(self, model_path: str, *, device: str = "auto",
        ...
        from src.solvers.hf_option_score_solver import HFOptionScoreSolver
        ...
        if self.cfg.enable_generation_fallback:
            from src.solvers.hf_generate_solver import HFGenerateSolver
