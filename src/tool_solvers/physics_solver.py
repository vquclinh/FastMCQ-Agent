...
from src.formula_bank_solver import (try_uniform_motion, try_kinetic_energy, try_potential_energy,
...
from src.calculation_solver import (try_resistor, try_relativistic_momentum,
