...
from src.solvers.formula_bank_solver import (try_roi, try_profit, try_break_even_quantity,
                                     ...
                                     try_monopoly_linear)
from src.solvers.calculation_solver import (try_operating_margin_asset_turnover, try_gdp_inflation,
