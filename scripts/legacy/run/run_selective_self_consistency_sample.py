...
from src.layers.adaptive_proposal_common import guard_output, load_pred, load_samples, write_csv, write_jsonl  # noqa: E402
...
def main(argv=None) -> int:
    ...
    client = None
    if not dry_run:
        from src.api.openrouter_client import OpenRouterClient   # lazy; only on --execute
