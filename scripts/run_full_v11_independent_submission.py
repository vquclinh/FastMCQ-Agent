...
from src.adaptive_routing import route_to_branch  # noqa: E402
from src.answer_factory import build_candidate_pool  # noqa: E402
from src.calculation_first_planner import (build_calculation_tool_context,  # noqa: E402
...
def _deterministic_low_risk(pool):
    from src.answer_ranker import _is_deterministic
...
def _load_agents_module():   # pragma: no cover
    from src import api_candidate_agents as agents
    return agents
