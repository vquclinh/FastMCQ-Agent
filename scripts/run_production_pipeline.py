...
from src.data_io import load_dataset, write_predictions  # noqa: E402
from src.labels import labels_for  # noqa: E402
from src.production_policy import decide  # noqa: E402
...
def main(argv=None) -> int:
    ...
    try:
        ...
        if args.direct_prompt:
            from src.openrouter_client import OpenRouterClient   # lazy; only on --direct-prompt
            from src.production_inference import predict_one_direct
